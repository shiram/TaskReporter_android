...
public class Receiver {
    ...
    private String server_msg, email, user_firstname, user_lastname, emp_id, user_image;
    private int id, access_level, is_team_leader, is_employee;
    ...
    public Receiver(Context context, ProgressDialog progressDialog, ListView listView) {
        this.context = context;
        this.progressDialog = progressDialog;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.LOGIN, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    emp_id = result.getString("employee_id");
                    access_level = result.getInt("access_level");
                    user_image = result.getString("user_image");
                    is_team_leader = result.getInt("is_team_leader");
                    is_employee = result.getInt("is_employee");
                ...
                progressDialog.dismiss();
                if(id > 0) {
                    customToast.setPrefs(id,user_firstname,user_lastname,email,access_level, emp_id, user_image,is_team_leader,is_employee);
    ...
    public void getAccounts(final String url) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(! (response == null || response.equals("")) ){
                    ...
                    adapterConnector = new AdapterConnector(context,response,listView);
                    adapterConnector.populateUserList();
    ...
    public void giveRights(final int id, final String url) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    JSONObject result = new JSONObject(response);
                    server_msg = result.getString("success");
                    Toast.makeText(context, "Rights Granted", Toast.LENGTH_SHORT).show();
    ...
    public void getUserTasks(final int id) {


        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.GET_USER_TASKS, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                if(! (response == null || response.equals("")) ){
                    adapterConnector = new AdapterConnector(context,response,listView);
                    adapterConnector.populateTaskList();
                }else {
                    customToast.setToast(Config.NO_SERVER_RESPONSE);
                }
